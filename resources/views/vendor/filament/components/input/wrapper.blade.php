...
@php
    ...
    $labelClasses = 'fi-input-wrp-label whitespace-nowrap text-sm/6 text-gray-500 dark:text-gray-400';

    $getIconClasses = fn (string | array $color = 'gray'): string => \Illuminate\Support\Arr::toCssClasses([
        'fi-input-wrp-icon h-4 w-4',
        match ($color) {
...
<div
    ...
    {{
        $attributes
            ->except(['wire:target'])
            ->class([
                'fi-input-wrp flex rounded-md ring-1 transition duration-75',
