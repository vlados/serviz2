...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...[
            'fi-btn relative grid-flow-col items-center justify-center font-normal outline-none transition duration-75 focus-visible:ring-2',
            ...
            match ($size) {
                ...
                ActionSize::Small => 'gap-1 px-3.5 py-2 text-xs',
        ...
        ...(
            $outlined ?
                ...
                [
                    'shadow ring-gray-950/5' => ! $grouped,
