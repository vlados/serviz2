...
>
    <div class="overflow-x-clip">
        <header
            class=" flex h-16 items-center  px-6 ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 "
        >
            <div
    ...
    <nav
        class="fi-sidebar-nav flex-grow flex flex-col gap-y-4 overflow-y-auto overflow-x-hidden p-4"
