...
>
    <nav
            class="flex items-center gap-x-4  px-4  md:px-6 lg:px-8 border-gray-100 border-b p-3"
    >
        ...
        <div
                x-persist="topbar.end" class="ms-auto flex items-center gap-x-4 w-full justify-end"
        >
